...
public class CachedUserService {
     ...
     * @return 사용자 정보
     */
    @Cacheable(value = "users", key = "#userId", cacheManager = "userCacheManager")
     ...
     * 사용자 삭제 (캐시 제거)
     */
    @CacheEvict(value = "users", key = "#userId", cacheManager = "userCacheManager")
    @Transactional
     ...
     * 모든 사용자 캐시 제거
     */
    @CacheEvict(value = "users", allEntries = true, cacheManager = "userCacheManager")
