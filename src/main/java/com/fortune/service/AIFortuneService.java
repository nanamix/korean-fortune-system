...
public class AIFortuneService {
    ...
    @Cacheable(value = "ai-saju-interpretation",
            key = "T(com.fortune.ai.AiFactPacket).CACHE_NAMESPACE + '_'"
                    + " + #sajuResult.dayMaster + '_' + #sajuResult.dayPillar")
    ...
    @Cacheable(value = "ai-daily-advice",
            key = "T(com.fortune.ai.AiFactPacket).CACHE_NAMESPACE + '_'"
                    + " + #dailyFortune.date + '_' + #dailyFortune.totalScore")
    ...
    @Cacheable(value = "ai-zodiac-advice",
            key = "T(com.fortune.ai.AiFactPacket).CACHE_NAMESPACE + '_'"
                    + " + #zodiacResult.zodiac + '_' + #zodiacResult.targetDate")
    ...
    @Cacheable(value = "ai-tojeong-advice",
            key = "T(com.fortune.ai.AiFactPacket).CACHE_NAMESPACE + '_'"
                    + " + #tojeongResult.gwaNumber + '_' + #tojeongResult.targetYear")
